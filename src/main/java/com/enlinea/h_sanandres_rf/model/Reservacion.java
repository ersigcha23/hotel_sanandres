...
public class Reservacion implements Serializable {
    ...
    @JoinColumn(name = "habitacion_idhabitacion", referencedColumnName = "idhabitacion")
    @ManyToOne(optional = false)
    ...
    public Reservacion(Integer idreservacion, Date fechaReserva, Date fechaEntrada, Date fechaSalida, float valorAcordado) {
        this.idreservacion = idreservacion;
    ...
    public String toString() {
        return "com.enlinea.h_sanandres_rf.model.Reservacion[ idreservacion=" + idreservacion + " ]";
    }
