...
import com.enlinea.h_sanandres_rf.model.Reservacion;
...
import com.enlinea.h_sanandres_rf.negocio.ReservacionFacade;
...
public class ReservacionController implements Serializable {
    ...
    @EJB
    private com.enlinea.h_sanandres_rf.negocio.ReservacionFacade ejbFacade;
    ...
    private ReservacionFacade getFacade() {
        return ejbFacade;
    }
