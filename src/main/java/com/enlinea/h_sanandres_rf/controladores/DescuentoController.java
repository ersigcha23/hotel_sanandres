...
import com.enlinea.h_sanandres_rf.model.Descuento;
...
import com.enlinea.h_sanandres_rf.negocio.DescuentoFacade;
...
public class DescuentoController implements Serializable {
    ...
    @EJB
    private com.enlinea.h_sanandres_rf.negocio.DescuentoFacade ejbFacade;
    ...
    public List<Descuento> getItems() {
        if (items == null) {
    ...
    public List<Descuento> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Descuento> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
